...
PM_START_TEXT = """
ʜᴇʟʟᴏ 🤗, ɪᴍ Garfield 🐱 ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(
            text="ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/media_bot_updates"
        ),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="Developer🧑‍💻", url=f"https://t.me/darkz_hacker_devil"),
    ],
]
...
amelia_IMG = "https://telegra.ph/file/f01626c931f28c92c48a1.jpg"
...
def amelia_about_callback(update, context):
    ...
    if query.data == "amelia_":
        query.message.edit_text(
            text=""" 🤟 I'm *Garfield 🐱*, a powerful group management bot built to help you manage your group easily.
                 \n\n©️ Name : *Garfield 🐱*
                 \n©️ Creator : 🧑‍💻[Ravidu Yasas](https://t.me/darkz_hacker_devil)
                 \n©️ Developers : [Bot Shadow](https://t.me/media_bot_updates)
                 \n©️ Language : Python
                 \n©️ Source Code : 🔐""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
